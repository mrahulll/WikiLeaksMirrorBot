...
'''
    ...
    buttons.buildbutton("Repo", "https://github.com/TheOnlyMrLucifer/WikiLeaksMirrorBot")
    buttons.buildbutton("Gateway", "https://t.me/+OJhL_NKxI8llOWY0)
    ...
    if CustomFilters.authorized_user(update) or CustomFilters.authorized_chat(update):
        ...
        sendMarkup(f"Oops! not a Authorized user.\nPlease deploy your own <b>WikiLeaksMirrorBot</b>.", context.bot, update, reply_markup)
