...
<body>
<h1>slam-mirrorbot: <a href="https://github.com/TheOnlyMrLucifer/WikiLeaksMirrorBot">@Github</a></h1>
...
async def homepage(request):
    ...
    return web.Response(text="<h1>See WikiLeaksMirrorBot <a href='https://github.com/TheOnlyMrLucifer/WikiLeaksMirrorBot'>@GitHub</a> By <a href='https://github.com/TheOnlyMrLucifer'>WikiLeaks</a></h1>",content_type="text/html")
  ...
  async def middleware_handler(request):
      ...
      try:
          ...
          if response.status == 404:
              return web.Response(text="<h1>404: Page not found</h2><br><h3>WikiLeaksMirrorBot</h3>",content_type="text/html")
          return response
